...
from tickets.views import crear_ticket, consultar_tickets, tomar_ticket, agente_dashboard, editar_ticket,MisTicketsView, dar_feedback,obtener_comentarios
...
urlpatterns = [
    ...
    path('mis-tickets/', MisTicketsView.as_view(), name='ver_mis_tickets'),
     ...
     path('tickets/<int:ticket_id>/comentarios/', obtener_comentarios, name='obtener_comentarios'),
]
